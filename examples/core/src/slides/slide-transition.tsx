    ...
    >
      <div className="flex-1 flex flex-col items-center justify-center gap-6">
        ...
        <p className="text-2xl text-sm-muted-foreground">
          this slide overrides the deck fade with a push
        </p>
        <p className="text-lg text-sm-muted-foreground">
          set <code className="font-mono text-sm-primary">defaultSlideTransition</code> once, then
          override per slide when needed
        </p>
      </div>
    </Slide>
  );
