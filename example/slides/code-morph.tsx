  ...
  return (
    <Slide id="code-morph" className="flex flex-col">
      <div className="flex-1 flex flex-col items-center justify-center gap-6 p-16">
        ...
        <p className="text-xl opacity-60">tokens animate between code states</p>
        <div className="w-full max-w-250 h-175 rounded-xl overflow-hidden bg-[#FAFAF8] shadow-2xl shadow-black/10 border border-black/8 flex flex-col">
          {/* Breadcrumb bar */}
          <div className="flex items-center gap-2 px-6 py-4 border-b border-black/8">
            <span className="font-mono text-lg text-black/40">
