...
export const defaultTheme = defineTheme({
  ...
  Overview: {
    className: "bg-sm-surface/95 flex items-center justify-center z-[1000]",
    classNames: {
  ...
  Terminal: {
    className: "rounded-sm overflow-hidden bg-sm-surface text-sm-surface-foreground font-mono",
    classNames: {
